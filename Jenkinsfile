...
pipeline {
  ...
  parameters {
    ...
    choice (name: "Component",   choices: ['base', 'nhais', 'OneOneOne', 'mhs', 'account', 'fake_mesh', 'nhais_responder', 'gp2gp', 'gpc-consumer', 'lab-results', 'pss'],     description: "Choose component")
